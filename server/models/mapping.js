...
Product.belongsToMany(User, { through: Reviews, onDelete: "CASCADE" });
User.belongsToMany(Product, { through: Reviews, onDelete: "CASCADE" });

Product.hasMany(Reviews, { as: "reviews", onDelete: "CASCADE" });
